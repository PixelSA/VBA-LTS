Sub RC_GoTo_Invoicing()
    ...
    fiscalYear = FiscalYearOf(ActiveSheet.Cells(ActiveCell.Row, FindInRow(1, "Start (noon)")).Value)
    Debug.Print
    ...
    If ActiveSheet.name = "Charters" Then
        ...
        basePath = ThisWorkbook.Path 'tweaked to work wherever, as long as the current file setup stays the same
        ...
        fullPath = basePath & "\" & boatName & "\Bookings\FY " & fiscalYear & "\FY " & fiscalYear & " " & boatName & " Charters.xlsm"
