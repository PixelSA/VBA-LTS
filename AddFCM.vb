...
Dim ws          As Worksheet
    ...
    For currentRow = startingRow To lastRow
        ...
        If ws.Cells(currentRow, currentCol).Interior.ColorIndex = xlNone Then
            ...
            If (ws.Cells(currentRow - 1, currentCol).Interior.Color = skipColor1 Or ws.Cells(currentRow - 1, currentCol).Interior.Color = skipColor2 Or ws.Cells(currentRow - 1, currentCol).Interior.Color = skipColor3 Or ws.Cells(currentRow - 1, currentCol).Interior.Color = skipColor4) And currentRow > dateRow Then ' will probably have to hardcode in specific colours later
